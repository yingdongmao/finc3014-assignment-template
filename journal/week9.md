...
> (`reports/week9-performance.pdf` — the download guide is on Canvas).
> Cash is a row too.
...
> Cmd+Shift+4), save it as `img/week9-cumret.png`, and it renders below.
> One sentence: what does the gap between the two lines say this week?

![Cumulative return vs benchmark](img/week9-cumret.png)
...
> (`reports/week9-trades.pdf`): use the order's **Total** line when it filled

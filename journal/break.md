# Mid-semester break week — trading journal

_The trading window runs straight through the break (Mon 28 Sep – Sun 4 Oct).
Markets don't take holidays — commit this entry during the break week like any
other (criterion A1)._
...
> (`reports/break-performance.pdf` — the download guide is on Canvas).
> Cash is a row too.
...
> Cmd+Shift+4), save it as `img/break-cumret.png`, and it renders below.
> One sentence: what does the gap between the two lines say this week?

![Cumulative return vs benchmark](img/break-cumret.png)
...
> (`reports/break-trades.pdf`): use the order's **Total** line when it filled

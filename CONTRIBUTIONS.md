# Contribution record — one row per member, committed by that member

**Why this file exists.** Your individual mark = group mark × your Individual
Contribution Factor (assignment brief, Section 5). This table is part of the
evidence — and committing your own row is the **signature** that proves your
GitHub account works and your contribution is on the record.
